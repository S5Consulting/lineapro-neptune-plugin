...
-(void)print3InchTicket
{
    ...
    [dtdev prnPrintBarcodePDF417:[@"M1TA/THAI HOA         EIZVNRI LGBSEAB6 0206 209R003C0002 147>3181OK5209BB6              29279          3 B6 B6                     ^160MEUCICht+/p4ZnM42SnW2B8vtVYsEKH7fWdpUrTvg4pMGJBrAiEAmph8K1A+kOcDmjJKCbualTL9UZ1rNp8vT5KeBWzcZDM=" dataUsingEncoding:NSASCIIStringEncoding] truncated:false autoEncoding:true eccl:PDF417_ECCL_AUTO size:PDF417_SIZE_W2_H4 error:&err];
...
-(void)print4InchTicket
{
    ...
    UIImage *p=[UIImage imageNamed:@"P.png"];
    COMMAND(@"Page Set Working Area",[dtdev pageSetWorkingArea:hoffset+56 top:46 width:-1 height:p.size.height error:&err]);
    COMMAND(@"P",[dtdev prnPrintImage:p align:ALIGN_LEFT error:&err]);
