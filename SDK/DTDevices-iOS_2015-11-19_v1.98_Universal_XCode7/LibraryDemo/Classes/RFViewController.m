...
//    {
//        //poll
//        //system code[2b], request code [1b], time slot[1b], timeoutms[2b]
//        uint8_t felica[] = { 0xFF, 0xFF, 0x01, 0x00, 0x00, 0x00 };
//        DTRFCardInfo *info=[dtdev rfDetectCardOnChannel:RF_CHANNEL_FELICA additionalData:[NSData dataWithBytes:felica length:sizeof(felica)] error:&error];
//        if(info)
//        {
